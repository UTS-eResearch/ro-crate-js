...
class ROCrate {
    ...
    // Add a value to an item's propery
    addValue(prop, val) {
   ...
   toGraph() {
    ...
    this.__graphIndex = {};
    this.__actualGraph = _.clone(this.getGraph()); // This is still an array
    var g = this.getGraph();
    g  = []; // Save space
    this._item_by_id = {};
    for (let item of this.__actualGraph){
